...
// source: talos/resource/resource.proto
...
import (
	...
	extResource "github.com/talos-systems/talos/pkg/machinery/api/resource"
...
func request_ResourceService_List_0(ctx context.Context, marshaler runtime.Marshaler, client extResource.ResourceServiceClient, req *http.Request, pathParams map[string]string) (extResource.ResourceService_ListClient, runtime.ServerMetadata, error) {
	var protoReq extResource.ListRequest
	var metadata runtime.ServerMetadata
...
func request_ResourceService_Watch_0(ctx context.Context, marshaler runtime.Marshaler, client extResource.ResourceServiceClient, req *http.Request, pathParams map[string]string) (extResource.ResourceService_WatchClient, runtime.ServerMetadata, error) {
	var protoReq extResource.WatchRequest
	var metadata runtime.ServerMetadata
...
func RegisterResourceServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extResource.ResourceServiceServer) error {
	mux.Handle("POST", pattern_ResourceService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/resource.ResourceService/Get")
		if err != nil {
...
func RegisterResourceServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterResourceServiceHandlerClient(ctx, mux, extResource.NewResourceServiceClient(conn))
}

// RegisterResourceServiceHandlerClient registers the http handlers for service ResourceService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "extResource.ResourceServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "extResource.ResourceServiceClient"
...
func RegisterResourceServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extResource.ResourceServiceClient) error {
	mux.Handle("POST", pattern_ResourceService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/resource.ResourceService/Get")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ResourceService_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/resource.ResourceService/List")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ResourceService_Watch_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/resource.ResourceService/Watch")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ResourceService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"resource.ResourceService", "Get"}, ""))

	pattern_ResourceService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"resource.ResourceService", "List"}, ""))

	pattern_ResourceService_Watch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"resource.ResourceService", "Watch"}, ""))
)

var (
	forward_ResourceService_Get_0 = runtime.ForwardResponseMessage

	forward_ResourceService_List_0 = runtime.ForwardResponseStream
