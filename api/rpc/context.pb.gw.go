...
// UnaryRPC     :call ContextServiceServer directly.
...
func RegisterContextServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ContextServiceServer) error {
	...
	mux.Handle("POST", pattern_ContextService_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/cluster.ContextService/List")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ContextService_List_0(rctx, inboundMarshaler, server, req, pathParams)
...
// RegisterContextServiceHandlerClient registers the http handlers for service ContextService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "ContextServiceClient".
...
func RegisterContextServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ContextServiceClient) error {
	...
	mux.Handle("POST", pattern_ContextService_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/cluster.ContextService/List")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ContextService_List_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
