<template>
  ...
  <div class="pagination" :style="{ opacity: isInvisivible ? 0 : 1 }">
    <t-icon
      icon="arrow-left"
...
.pagination__icon {
  @apply fill-current text-naturals-N8 cursor-pointer transition-all duration-200 hover:text-naturals-N9;
  width: 18px;
  height: 18px;
}
