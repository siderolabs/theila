...
<template>
  <div class="flex flex-col">
    ...
    <div class="px-3 py-2" v-else>
      <h1
        class="text-lg tracking-tight text-talos-gray-900 dark:text-white font-bold"
      >
        Nodes
      </h1>
    </div>
    ...
    >
      <template v-slot:header>
        <div
          class="flex items-center grid-cols-4 md:grid-cols-7 lg:grid-cols-7"
        >
          <div class="block justify-self-left text-n">
            Name
          </div>
          ...
          <div
            class="col-span-2 block justify-self-center hidden md:block lg:block"
          >
            Roles
          </div>
